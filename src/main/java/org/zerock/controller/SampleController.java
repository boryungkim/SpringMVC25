...
@Controller // servlet-context.xml에서 <context:component-scan base-package =
...
public class SampleController {
	...
	public void basic() {
		...
		// 리턴이 void이므로 : 파일 [WEB-INF/views/sample.jsp]를 찾을 수 없습니다
	...
	public String ex01(SampleDTO dto) { // SampleDTO dto = new SampleDTO();
		...
		return "mbcex01"; // WEB-INF/views/ex01.jsp -> servlet-context.xml이 하는 일
	...
	public String ex02(@RequestParam("owner") String name, @RequestParam("age") int age) {
		//프론트 변수와 백엔드의 변수가 다를 때 (초보자는 일치시키는 걸 권장)
		log.info("name : " + name);
		log.info("age : " + age);
		return "ex02";
	}
	...
	@GetMapping("/ex04")
	public String ex04(SampleDTO dto, @ModelAttribute("page") int page) { //int page는 게시판에 페이징 기법 예시
	...
	public ResponseEntity<String> ex07(){
		//ResponseEntity<String> 응답헤더 (200 OK, 404, 304)
